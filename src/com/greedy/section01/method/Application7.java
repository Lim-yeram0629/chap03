...
public class Application7 {
	...
	public static void main(String[] args) {
		...
		System.out.println(first + " + " + second + " = " + app7.plusTwoNumbers(first, second));
		System.out.println(first + " - " + second + " = " + app7.minusTwoNumbers(first, second));
		System.out.println(first + " * " + second + " = " + app7.multipleTwoNumbers(first, second));
		System.out.println(first + " / " + second + " = " + app7.devideTwoNumbers(first, second));
